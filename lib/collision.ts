...
export function checkCollisions(bars: Bar[]) {
  let nBars = [...bars]
...
export function reviewBars(bars: Bar[], eBar: Bar): [Bar[], Bar] {
  let editingBar = { ...eBar }
...
export const collided = (bar1: Bar, bar2: Bar): [Bar, Bar] => {
...
export const checkHasCollisionObject = (bar: Bar): Bar => {
  return { ...bar, collisions: {} }
}

export const removeCollision = (bar1: Bar, bar2: Bar) => {
